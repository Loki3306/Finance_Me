    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      <header className="container mx-auto flex items-center justify-between px-4 py-6">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-lg bg-emerald-500 grid place-items-center font-bold">
            FF
          </div>
          <span className="font-semibold">FlowFinance</span>
        </div>
        <nav className="flex items-center gap-3">
          <Link to="/sign-in" className="text-slate-200 hover:text-white">
            Sign in
          </Link>
        ...
        <section className="py-16 md:py-24 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-300 text-lg">
              Smart budgeting with UPI, Credit Card, and Cash support. Achieve
              financial goals with intelligent insights and secure
              authentication.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3 text-slate-300">
              <ShieldCheck className="text-emerald-400" /> Secure authentication
              and data protection
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-xl bg-emerald-500/20 p-4">
                ...
                <p className="text-sm text-slate-200/80">
                  Bank, UPI, and Cash in one place
                </p>
              </div>
              <div className="rounded-xl bg-emerald-500/20 p-4">
                <CreditCard />
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            <div className="rounded-xl bg-white/10 border border-white/20 p-4">
              <p className="text-slate-200">
                “FlowFinance makes managing UPI and cards simple. I finally see
                where my money goes.”
              </p>
            ...
            <div className="rounded-xl bg-white/10 border border-white/20 p-4">
              <p className="text-slate-200">
                “The budgeting and goals changed how I plan monthly expenses.”
              </p>
            ...
            <div className="rounded-xl bg-white/10 border border-white/20 p-4">
              <p className="text-slate-200">
                “Secure, fast, and tailored for Indian payments.”
              </p>
