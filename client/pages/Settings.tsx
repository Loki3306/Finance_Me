        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => setPrefs({ ...prefs, dateFormat: v })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => setPrefs({ ...prefs, fiscalYearStart: v })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center justify-between border rounded-lg p-3">
            ...
            <Switch
              checked={!!prefs.notifications?.goalReminders}
              onCheckedChange={(v) =>
                setPrefs({
                  ...prefs,
          ...
          <div className="flex items-center justify-between border rounded-lg p-3">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                setPrefs({
                  ...prefs,
                  privacy: { ...prefs.privacy, shareAnalytics: v },
                })
              }
            />
          </div>
      ...
      <section className="rounded-xl border p-4">
        ...
        <div className="grid gap-3">
          <Button
            variant="outline"
            onClick={async () => {
              await apiFetch("/api/settings/export", { method: "POST" });
            }}
          >
          ...
          <Button
            variant="destructive"
            onClick={async () => {
              await apiFetch("/api/settings/reset", { method: "DELETE" });
              location.reload();
            }}
          >
            Reset Preferences
