  ...
  async function complete() {
    ...
    try {
      ...
      if (accountType === "credit_card") {
        payload.creditLimit = isNaN(creditLimitNum)
          ? undefined
          : creditLimitNum;
        ...
        <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur p-6">
          {step === 1 && (
            <div className="space-y-4">
              ...
              <p className="text-slate-300">
                FlowFinance helps you track expenses across UPI, Credit Cards,
                and Cash with smart budgeting and insights.
              </p>
              <div className="pt-2">
                <Button
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div className="pt-2 flex items-center gap-2">
                ...
                <Button
                  disabled={(accountType === "upi" && !upiValid) || loading}
                  className="bg-emerald-600 hover:bg-emerald-700"
                  onClick={() => setStep(3)}
                >
                  Continue
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              <p className="text-slate-300">
                You're all set. We'll finalize your setup and take you to the
                dashboard.
              </p>
              {error && <div className="text-red-300 text-sm">{error}</div>}
              <div className="pt-2 flex items-center gap-2">
